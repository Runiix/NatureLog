...
/** Sections 1–4: controller, legal bases, hosting, cookies. */
...
/** Sections 5–9: account, profile, uploads and other user-generated data. */
function PrivacyAccountData() {
  return (
    <>
...
/** Sections 10–14: email, external services and third-country transfers. */
function PrivacyThirdParties() {
  return (
    <>
...
/** Sections 15–18: retention, data subject rights, security, changes. */
