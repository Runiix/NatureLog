...
import BackButton from "@/app/[locale]/components/general/BackButton";
import { getUser } from "@/app/[locale]/utils/data";
import RecentAnimalImageUploads from "@/app/[locale]/components/animals/RecentAnimalImageUploads";
...
export default async function AnimalPage(params: any) {
  ...
  return (
    <div className="relative">
      ...
      <div className="shadow-black relative top-[30vh] sm:top-[50vh] md:top-[70vh] shadow-lg bg-gradient-to-br border-gray-200 border from-gray-900 to-70% transition-all duration-200 to-gray-950 rounded-lg py-2 w-[98%] lg:w-11/12 xl:w-10/12 mx-auto overflow-hidden">
        <div className=" m-4 sm:mx-10 sm:my-6 flex-col flex gap-8">
          <div className="flex flex-col lg:flex-row justify-between w-full border-b pb-4 border-slate-400 gap-4 sm:gap-0">
            ...
            <div className="flex flex-col gap-4 text-nowrap">
              ...
              <div className="text-lg md:text-xl flex flex-wrap gap-2 items-center -ml-1">
                <div className="flex gap-1 items-center">
                  <CalendarMonth />
