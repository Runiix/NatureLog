    ...
    <div>
      {user ? (
        ...
        <nav className="absolute w-full top-0 py-3 flex items-center justify-between bg-gray-200 z-50">
          ...
          <div
            className={`shadow-xl shadow-black transition-all items-center duration-500 sm:invisible fixed left-0 top-20 text-xl w-full rounded-lg flex flex-col gap-3 text-center bg-gray-900 border-y border-slate-400  ${
              toggleMenu ? "scale-100 opacity-100" : "scale-0 opacity-0"
            } `}
          >
            <div className="flex flex-col items-center p-4 gap-6">
              ...
              <div>
                <Link
                  href="/loginpage"
                  className="text-slate-100 hover:text-slate-900 bg-green-600 transition-all duration-200 p-2 px-4 rounded-md"
                >
                  Anmelden
                </Link>
              </div>
