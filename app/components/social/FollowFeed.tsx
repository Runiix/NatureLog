...
export default function FollowFeed({ following }: { following: number[] }) {
  ...
  return (
    <div className="flex flex-col w-[21rem] sm:w-96 sm:min-w-96 gap-4 rounded-lg shadow-black shadow-lg max-h-[500px] min-h-[500px] sm:min-h-[386px] sm:max-h-[792px] 2xl:min-h-[792px]  bg-gradient-to-br  from-gray-900 to-70% transition-all duration-200 to-gray-950 border hover:border-green-600 border-slate-200 group">
